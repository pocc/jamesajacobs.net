...
export default function ContactForm() {
    ...
    async function handleSubmit(e: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            const response = await fetch('https://formsubmit.co/ajax/geojimj@gmail.com', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', Accept: 'application/json' },
                body: JSON.stringify({ ...data, _subject: `Contact form: ${data.subject ?? data.name}`, _replyto: data.email }),
            })
